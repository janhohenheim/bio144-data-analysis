...
## - A small one: Males are slightly faster
## What is the effect size (i.e. the magnitude of the difference?)
## - Very minor, I guess 20 ms
...
my_ttest <- t.test(class_RTs_filtered$Pref_Reaction_time ~ class_RTs_filtered$Gender,
...
# - Big assumptions: Both groups have he same access to mice or mouse vs touchpad makes no difference
...
# - All touchpad, normalize by hobbies
# What are the implications of the findings?
# - With their current setup, males in the classroom who participated could be slightly faster than females
#######################################################
...
## - With a certainty of about 90%, we conclude that in the measured sample, males are on average around 15ms faster than females
